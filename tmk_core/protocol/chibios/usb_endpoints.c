...
// clang-format off
    ...
    QMK_USB_REPORT_STORAGE(
        ...
        QMK_USB_REPORT_STROAGE_ENTRY(REPORT_ID_MOUSE, MOUSE_REPORT_SIZE),
#endif
...
// clang-format on
    ...
    [USB_ENDPOINT_IN_MOUSE] = QMK_USB_ENDPOINT_IN(USB_EP_MODE_TYPE_INTR, MOUSE_EPSIZE, MOUSE_IN_EPNUM, MOUSE_IN_CAPACITY, NULL, QMK_USB_REPORT_STORAGE_DEFAULT(MOUSE_REPORT_SIZE)),
#endif

#if defined(POINTING_DEVICE_HIRES_SCROLL_MACOS_ENABLE)
    [USB_ENDPOINT_IN_MACOS_SCROLL] = QMK_USB_ENDPOINT_IN(USB_EP_MODE_TYPE_INTR, MACOS_SCROLL_EPSIZE, MACOS_SCROLL_IN_EPNUM, MACOS_SCROLL_IN_CAPACITY, NULL, QMK_USB_REPORT_STORAGE_DEFAULT(sizeof(report_macos_scroll_t))),
#endif
...
#if defined(POINTING_DEVICE_HIRES_SCROLL_MACOS_ENABLE)
    [MACOS_SCROLL_INTERFACE] = USB_ENDPOINT_IN_MACOS_SCROLL,
#endif
