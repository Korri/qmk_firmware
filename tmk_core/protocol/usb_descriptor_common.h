...
#        if !defined(PROTOCOL_CHIBIOS) && !defined(PROTOCOL_LUFA)
#            error "POINTING_DEVICE_HIRES_SCROLL_MACOS_ENABLE is only supported by ChibiOS and LUFA"
#        endif
#    endif
...
#    else
#        ifdef POINTING_DEVICE_HIRES_SCROLL_MACOS_ENABLE
#            define POINTING_DEVICE_HIRES_SCROLL_MULTIPLIER 8
#        else
...
#if defined(POINTING_DEVICE_HIRES_SCROLL_MACOS_ENABLE) && !defined(POINTING_DEVICE_HIRES_SCROLL_ENABLE)
#    error "POINTING_DEVICE_HIRES_SCROLL_MACOS_ENABLE requires POINTING_DEVICE_HIRES_SCROLL_ENABLE"
#endif

#if defined(POINTING_DEVICE_HIRES_SCROLL_MACOS_ENABLE) && !defined(OS_DETECTION_ENABLE)
#    error "POINTING_DEVICE_HIRES_SCROLL_MACOS_ENABLE requires OS_DETECTION_ENABLE"
#endif
